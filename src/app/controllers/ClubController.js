...
class ClubController {
  async index(req, res) {
    ...
    return res.json({
      ...
      totals: {
        ...totals,
        average_age: totals.average_age / totals.total_age_informed,
      },
    });
  }
  ...
  async store(req, res) {
    ...
    const schema = Yup.object().shape({
      ...
      session_start: Yup.string().required('Início da temporada é obrigatório'),
      session_end: Yup.string().required('Fim da temporada é obrigatório'),
  ...
  async update(req, res) {
    ...
    const updatedData = await findResponse.update({
      ...
      session_start: body_request.session_start,
      session_end: body_request.session_end,
